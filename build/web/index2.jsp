...
<html lang="en">
    ...
    <body>
        ...
        <form method="get" action="confirmalogin.jsp" class="formulario">
            <h2>¡Bienvenido a la pagina de login! <br>Identifíquese para poder acceder al listado Marvel en modo administrador</h2>
            ...
            <a id="Salir" action="index.jsp" type="submit" value="Volver al inicio">
        </form>
